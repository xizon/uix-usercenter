# Uix Custom Meta Boxes ( For Uix UserCenter and your Theme )
...
if ( class_exists( 'Uix_UserCenter_Custom_Metaboxes' ) ) {
			...
			'config' => array( 
				...
				'fields' => array( 
					...
					array(
						...
						'desc_primary'  =>  Uix_UserCenter_Custom_Metaboxes::kses( __( 'Enter date of your projects. <strong>(optional)</strong>', 'your-theme' ) ),
						'options'       =>  array( 
											'format'  => 'MM dd, yy',
										  )
	...
	$custom_metaboxes_page = new Uix_UserCenter_Custom_Metaboxes( $custom_metaboxes_page_vars );
}
...
//@print: 
    <?php
    echo Uix_UserCenter_Custom_Metaboxes::kses( get_post_meta( get_the_ID(), 'cus_page_ex_demoname_appear_3', true ) );
    ?>
    ...
    if ( is_array( $_data ) && sizeof( $_data ) > 0 ) {
        ...
        ?>
            <li>
                ...
                <p>
                    <?php echo Uix_UserCenter_Custom_Metaboxes::kses( $value[ 'value' ] ); ?>
                </p>
            </li>
        <?php
        }
...
//@print: 
	...
	<div class="slide-wrapper">
		<?php
			...
			//
			$all_data_res = is_array($all_data) ? json_decode( Uix_UserCenter_Custom_Metaboxes::format_json_str( $all_data[0]['all_data'] ), true ) : []; 
			$all_reverse_data_res = is_array($all_data) ? json_decode( Uix_UserCenter_Custom_Metaboxes::format_json_str( $all_data[0]['all_reverse_data'] ), true ) : []; // Reverse Order of Data
				...
				foreach( $_data as $index => $value ) {
					...
					if ( is_array( $value ) && sizeof( $value ) > 0 ) {
						...
						<section class="slide <?php echo ( !empty($parent) ? 'slide-child' : ''); ?> <?php echo esc_attr( $value[ 'classname' ] ); ?>" id="<?php echo esc_attr( $value[ 'id' ] ); ?>" data-parent="<?php echo esc_attr( $parent ); ?>">
							...
							<?php echo Uix_UserCenter_Custom_Metaboxes::kses( $value[ 'desc' ] ); ?>
							<hr>
							<?php echo Uix_UserCenter_Custom_Metaboxes::kses( $value[ 'value' ] ); ?>
        ...
        foreach( $_data as $index => $value ) {
            ...
            ?>
                <div class="uix-portfolio-type-<?php echo esc_attr( $value[ 'type' ] ); ?>">
                    ...
                    <?php echo Uix_UserCenter_Custom_Metaboxes::kses( Uix_UserCenter_Custom_Metaboxes::format_json_str( $value[ 'value' ] ) ); ?>
