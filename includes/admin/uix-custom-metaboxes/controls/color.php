...
*
*/
class UixUserCenterCmbFormType_Color extends Uix_UserCenter_Custom_Metaboxes {
	...
	?>
		...
		<?php endif; ?>     
				   ...
				   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-usercenter-cmb__color-selector" value="<?php echo esc_attr( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
