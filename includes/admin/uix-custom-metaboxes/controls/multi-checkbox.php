...
*
*/
class UixUserCenterCmbFormType_MultiCheckbox extends Uix_UserCenter_Custom_Metaboxes {
	...
	?>
		...
		<?php endif; ?>
				...
				<div class="uix-usercenter-cmb__multi-checkbox-selector">
						...
						if ( is_array ( $options )  && isset( $options[ 'value' ] ) ) {
							...
							foreach ( $options[ 'value' ] as $key => $value  ) {
								...
								<label class="<?php if ( $br ) { echo 'uix-usercenter-cmb__label'; } else { echo ''; }; ?>">
