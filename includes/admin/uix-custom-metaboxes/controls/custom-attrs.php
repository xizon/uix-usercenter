...
*
*/
class UixUserCenterCmbFormType_CustomAttrs extends Uix_UserCenter_Custom_Metaboxes {
	...
	public static function add( $id = '', $title = '', $desc = '', $default = '', $options = '', $placeholder = '', $desc_primary = '', $enable_table = false ) {
		...
		$temp = '
			<div class="uix-usercenter-cmb__text--div">
				<label class="uix-usercenter-cmb__text--p">
					<p class="uix-usercenter-cmb__description">
						'.esc_html( $label_title ).'
					</p>
					<input class="uix-usercenter-cmb__text--small" name="'.esc_attr( $id ).'_attrs_title[]" value="{name}"><span class="important2">*</span>&nbsp;&nbsp;
				</label>
