...
*
*/
class UixUserCenterCmbFormType_Url extends Uix_UserCenter_Custom_Metaboxes {
	...
	?>
		...
		<?php endif; ?>      
				   ...
				   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-usercenter-cmb__normal-text" value="<?php echo esc_url( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
