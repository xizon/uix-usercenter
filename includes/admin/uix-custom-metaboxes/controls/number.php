...
*
*/
class UixUserCenterCmbFormType_Number extends Uix_UserCenter_Custom_Metaboxes {
	...
	?>
		...
		<?php endif; ?>    
				   ...
				   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-usercenter-cmb__short-text" value="<?php echo ( empty( $default ) ) ? 0 : floatval( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
					<?php 
