...
*
*/
class UixUserCenterCmbFormType_MultiPortfolio extends Uix_UserCenter_Custom_Metaboxes {
	...
	public static function add( $id = '', $title = '', $desc = '', $default = '', $options = '', $placeholder = '', $desc_primary = '', $enable_table = false ) {
		...
		$label_type           = array( 
									'file' => esc_html__( 'Files', 'uix-usercenter' ),
									'html' => esc_html__( 'Text', 'uix-usercenter' )
								);
		$label_html           = esc_html__( 'Custom Content', 'uix-usercenter' );
		$label_file           = esc_html__( 'Upload Your Files', 'uix-usercenter' );
		$label_upbtn_remove   = esc_html__( 'Remove', 'uix-usercenter' );
		$label_upbtn_add_file = esc_html__( 'Add Files', 'uix-usercenter' );
		$label_upbtn_add_html = esc_html__( 'Add Text', 'uix-usercenter' );
		...
		//lightbox
		$label_lightbox = esc_html__( 'Enable Lightbox for this gallery?', 'uix-usercenter' );
		...
		$type_res = '<select class="uix-usercenter-cmb__text--fullwidth uix-usercenter-cmb__text--div--toggle__simple-sel">';
		...
		$temp = '
			...
			<div class="uix-usercenter-cmb__text--div uix-usercenter-cmb__text--div--toggle uix-usercenter-cmb__text--div--toggle--sortable">
				...
				<a href="javascript:void(0);" class="uix-usercenter-cmb__custom-attributes-field__sortablebtn">
			   ...
			   <a href="javascript:void(0);" class="uix-usercenter-cmb__custom-attributes-field__removebtn" title="'.esc_attr( $label_upbtn_remove ).'"><svg aria-hidden="true" role="img" focusable="false" class="dashicon dashicons-trash" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path d="M12 4h3c.6 0 1 .4 1 1v1H3V5c0-.6.5-1 1-1h3c.2-1.1 1.3-2 2.5-2s2.3.9 2.5 2zM8 4h3c-.2-.6-.9-1-1.5-1S8.2 3.4 8 4zM4 7h11l-.9 10.1c0 .5-.5.9-1 .9H5.9c-.5 0-.9-.4-1-.9L4 7z"></path></svg></a>
				...
				<div class="uix-usercenter-cmb__text--div--toggle__div">
					...
					<label class="uix-usercenter-cmb__text--row" data-type="file">
					...
					<label class="uix-usercenter-cmb__text--row" data-type="html">
						<p class="uix-usercenter-cmb__description">
							'.esc_html( $label_html ).'
						</p>
	...
	?>
		...
		<?php endif; ?>	
				...
				<!-- Begin Fields -->
				<div class="uix-usercenter-cmb__wrapper uix-usercenter-cmb__custom-attributes-field <?php echo esc_attr( $one_column? 'uix-usercenter-cmb__wrapper--one-column' : '' ); ?>" data-append-id="<?php echo esc_attr( $id ); ?>_append" data-tmpl='<?php echo esc_attr( $temp_attr ); ?>'>
					...
					<?php endif; ?>	
								...
								<div class="uix-usercenter-cmb__checkbox-selector" <?php echo ( empty( $label_lightbox ) || $label_lightbox === false ? 'style="display: none;"' : '' ); ?>>
									...
									<label>
										...
										<?php if ( !empty ( $label_lightbox ) ) { ?>
											<span class="uix-usercenter-cmb__description"><?php echo esc_html( $label_lightbox ); ?></span>
										<?php } ?>
								...
								<div class="uix-usercenter-cmb__custom-attributes-field__addbtn__wrapper uix-usercenter-cmb__custom-attributes-field__addbtn__wrapper--multi">
									 <a href="javascript:void(0);" class="uix-usercenter-cmb__custom-attributes-field__addbtn uix-usercenter-cmb__custom-attributes-field__addbtn--multi" data-type="file">
			...
			L384,298.667H128z"/></g></svg>
									 ...
									 <a href="javascript:void(0);" class="uix-usercenter-cmb__custom-attributes-field__addbtn uix-usercenter-cmb__custom-attributes-field__addbtn--multi" data-type="html">
