 ...
 *************************************************
 */
 const UixUserCenterCustomMetaboxes = function( obj ) {
	"use strict";


	const UixUserCenterCustomMetaboxesConstructor = function( obj ) {
		this.init = obj;
	};

	UixUserCenterCustomMetaboxesConstructor.prototype = {
		...
		getInstance: function() {
			...
			jQuery( document ).ready( function() {
				...
				UixUserCenterCustomMetaboxesConstructor.prototype.radio.call( this, '.uix-usercenter-cmb__radio-selector' );
				UixUserCenterCustomMetaboxesConstructor.prototype.toggle.call( this, '.uix-usercenter-cmb__toggle-selector' );
				UixUserCenterCustomMetaboxesConstructor.prototype.color.call( this, '.uix-usercenter-cmb__color-selector' );
				UixUserCenterCustomMetaboxesConstructor.prototype.tabs.call( this, '.uix-usercenter-cmb__tabsgroup-selector' );
				UixUserCenterCustomMetaboxesConstructor.prototype.date.call( this, '.uix-usercenter-cmb__date-selector' );
				UixUserCenterCustomMetaboxesConstructor.prototype.customAttrs.call( this, '.uix-usercenter-cmb__custom-attributes-field', 100 );
                UixUserCenterCustomMetaboxesConstructor.prototype.expandItem.call( this, '.uix-usercenter-cmb__text--div--toggle__trigger' );
                UixUserCenterCustomMetaboxesConstructor.prototype.titleChange.call( this, '.uix-usercenter-cmb__text--div--toggle', '.uix-usercenter-cmb__text--div--toggle__trigger', '.uix-usercenter-cmb__text--div--toggle__title' );          
                UixUserCenterCustomMetaboxesConstructor.prototype.upload.call( this );
                UixUserCenterCustomMetaboxesConstructor.prototype.editor.call( this, false );
                UixUserCenterCustomMetaboxesConstructor.prototype.toggleSelect.call( this );
		...
		expandItem: function( selector ) {
			...
			jQuery( document ).ready( function() {
                jQuery( document ).off( 'click.UixUserCenterToggle' ).on( 'click.UixUserCenterToggle', selector, function(e) {
                    e.preventDefault();
					...
					const switchFun = function( curSel ) {
						...
						$this.find( '[data-switch-ids]' ).each( function()  {
							const _targetID      = jQuery( this ).attr( 'data-switch-ids' ),
								_targetIDs     = UixUserCenterGetRealIds( _targetID  );
						...
						//
						if ( allSwitchIds != '' ) {
							jQuery( UixUserCenterGetRealIds( allSwitchIds  ) ).closest( 'tr' ).hide();
						}
						...
						const switchTargetID = curSel.attr( 'data-switch-ids' ),
							switchTargetIDs = UixUserCenterGetRealIds( switchTargetID  );
				...
				jQuery( selector ).each(function(){
                    ...
                    if ( $this.hasClass( 'active' ) ) {
                        if ( tid != '' || typeof tid !== typeof undefined ) {
                            $this.closest( '[data-target-id]' ).find( '.uix-usercenter-cmb__toggle-target' ).hide();
                            jQuery( '#' + tid ).show();
                        }
                    }
		...
		editor: function( reset ) {
			...
			jQuery( document ).ready( function() {
                ...
                //Initialize Editor
                jQuery( '.uix-usercenter-cmb__mce-editor' ).UixUserCenterEditorInit({init: reset});
		...
		toggleSelect: function() {
			...
			jQuery( document ).ready( function() {
                ...
                jQuery( '.uix-usercenter-cmb__wrapper.uix-usercenter-cmb__custom-attributes-field.uix-usercenter-cmb__custom-attributes-field--customlevel' ).UixUserCenterToggleSelectInit();
				
				//Initialize Select of Toggle
                jQuery( '.uix-usercenter-cmb__text--div--toggle__simple-sel' ).UixUserCenterToggleSimpleSelectInit({ type: 'file'});
		...
		upload: function() {
			...
			jQuery( document ).ready( function() {
                ...
                const selector = '.uix-usercenter-cmb__upload-target';
				...
				jQuery( selector ).each( function()  {
                    ...
                    $this.next( _closebtn ).off( 'click.UixUploadClose' ).on( 'click.UixUploadClose', function( event ){
                        ...
                        jQuery( this ).hide();
                        jQuery( this ).closest( '.uix-usercenter-cmb__upload-wrapper' ).find( selector ).show();
                        jQuery( this ).closest( '.uix-usercenter-cmb__upload-wrapper' ).find( selector ).attr( 'aria-disabled', true );
                    ...
                    $this.off( 'click.UixUpload' ).on( 'click.UixUpload', function( e ) {
                        ...
                        if ( $thisClick.attr( 'aria-disabled' ) == 'true' ) {
                            ...
                            upload_frame = wp.media( {
								title: uix_usercenter_custom_metaboxes_lang.ed_media_title,
								button: {
								text: uix_usercenter_custom_metaboxes_lang.ed_media_text,
                            },
                                multiple: false
                            } );
		...
		customAttrs: function( selector, max ) {
			...
			jQuery( document ).ready( function() {
				...
				jQuery( selector ).each(function(){
					...
					const $this     = jQuery( this ),
						$addButton  = $this.find( '.uix-usercenter-cmb__custom-attributes-field__addbtn' ), //The add button selector ID or class
					...
					//Prevent duplicate function assigned
					$addButton.off( 'click.UixUserCenterCustomMetaboxes_customAttrs_add' ).on( 'click.UixUserCenterCustomMetaboxes_customAttrs_add', function( e ) {
						e.preventDefault();
						...
						if( x < maxField ){ 
                            ...
                            const uuid = UixUserCenterGUIDCreate();
                            ...
                            jQuery.when( jQuery( wrapperID ).length > 0 ).then( function() {
                                ...
                                if ( typeof $btn.data( 'type' ) !== typeof undefined ) {
									...
									//Initialize Select of Toggle
                                   jQuery( '.uix-usercenter-cmb__text--div--toggle__simple-sel' ).UixUserCenterToggleSimpleSelectInit({ type: $btn.data( 'type' ) });
                                ...
                                //Initialize Editor
                                UixUserCenterCustomMetaboxesInit.editor( false );
                                
                                

                                //Initialize Uploader
                                UixUserCenterCustomMetaboxesInit.upload();
						...
						//Fold all items
						jQuery( '.uix-usercenter-cmb__text--div--toggle__trigger' ).parent().removeClass( 'active' );
						jQuery( '.uix-usercenter-cmb__text--div--toggle__trigger' ).removeClass( 'active' );
					...
					//Prevent duplicate function assigned
					jQuery( '.uix-usercenter-cmb__custom-attributes-field__removebtn' ).off( 'click.UixUserCenterCustomMetaboxes_customAttrs_remove' );
					jQuery( document ).on( 'click.UixUserCenterCustomMetaboxes_customAttrs_remove', '.uix-usercenter-cmb__custom-attributes-field__removebtn', function( e ) {
						e.preventDefault();
                        
                        //fixed click events firing multiple times
                        e.stopImmediatePropagation();
                        
                        if ( confirm( uix_usercenter_custom_metaboxes_lang.delete_confirm_text ) ) {
                            const $li = jQuery( this ).closest( '.uix-usercenter-cmb__text--div' );

                            if ( jQuery( '.uix-usercenter-cmb__custom-attributes-field .uix-usercenter-cmb__text--div' ).length == 1 ) {
                                $li.find( 'input' ).val( '' );
                                $li.hide();
                            } else {
                                $li.remove();
                    ...
                    jQuery( '.uix-usercenter-cmb__custom-attributes-field' ).sortable({
                        items                   : '.uix-usercenter-cmb__text--div--toggle--sortable',
                        handle                  : '.uix-usercenter-cmb__custom-attributes-field__sortablebtn',
                        cursor                  : 'move',
                        ...
                        stop:function( event,ui ){
                            ...
                            //Initialize Editor
                            UixUserCenterCustomMetaboxesInit.editor( true );   
	...
	return new UixUserCenterCustomMetaboxesConstructor( obj );
};
...
//--------
const UixUserCenterCustomMetaboxesInit = new UixUserCenterCustomMetaboxes();
UixUserCenterCustomMetaboxesInit.getInstance(); 
...
"use strict";
    $( function() {
		...
		if ( typeof(tinymce) !== 'undefined' ) {
			...
			tinymce.PluginManager.add('uix_usercenter_cmb_customcode', function(editor) {
				function showDialog() {
					const win = editor.windowManager.open({
						title: uix_usercenter_custom_metaboxes_lang.ed_sourcecode_title,
						body: {
							type: 'textbox',
							name: 'uix_usercenter_cmb_customcode',
							multiline: true,
						...
						onSubmit: function(e) {
							...
							if(editor.readonly != true){
								editor.undoManager.transact(function() {
									editor.setContent(e.data.uix_usercenter_cmb_customcode);
								});
							}
					...
					win.find('#uix_usercenter_cmb_customcode').value(editor.getContent({source_view: true}));

					//disable source code editing while in readonly mode
					if(editor.readonly){
						const id = win.find('#uix_usercenter_cmb_customcode')[0]._id;
						$(win.find('#uix_usercenter_cmb_customcode')[0]._elmCache[id]).prop('readonly', true);
					}
				...
				editor.addButton('uix_usercenter_cmb_customcode', {
					icon: 'code',
					tooltip: uix_usercenter_custom_metaboxes_lang.ed_sourcecode_title,
					onclick: showDialog,
					classes:'uix_usercenter_cmb_customcode'
				});

				editor.addMenuItem('uix_usercenter_cmb_customcode', {
					icon: 'code',
					text: uix_usercenter_custom_metaboxes_lang.ed_sourcecode_title,
					context: 'tools',
					onclick: showDialog
				});
			});	
...
( function ( $ ) {
	'use strict';
    $.fn.UixUserCenterMCEEditor = function( options ) {
        ...
        this.each( function() {
            ...
            if( typeof id !== typeof undefined ) {
				...
				tinymce.init({
					...
					//---
					language_url : (uix_usercenter_custom_metaboxes_lang.ed_lang != 'en_US' ) ? uix_usercenter_custom_metaboxes_lang.ed_url +  'js/tinymce/langs/'+uix_usercenter_custom_metaboxes_lang.ed_lang+'.js' : false,  // site absolute URL
					//---
					...
					plugins: 'textcolor image media hr uix_usercenter_cmb_customcode colorpicker lists fullscreen',		
				    toolbar: toolbar,
					setup:function( ed ) {
					   ...
					   ed.on( 'change', function(e) {
						   ...
						   var newvalue = ed.getContent()
														 .replace(/\r?\n/gm, '' )
														 .replace(/\.\.\/wp-content\/uploads\//g, uix_usercenter_custom_metaboxes_lang.upload_dir_url );
						...
						ed.addButton('uix_usercenter_cmb_image', {
						  icon: 'mce-ico mce-i-image',
						  tooltip: uix_usercenter_custom_metaboxes_lang.ed_image,
						  onclick: uix_mce_insertImage
						});
						
						
						// Add link button
						ed.addButton('uix_usercenter_cmb_link', {
							icon: 'mce-ico mce-i-link',
							tooltip: uix_usercenter_custom_metaboxes_lang.ed_link_title,
							onclick: function (e) {
								...
								ed.windowManager.open( {
									title: uix_usercenter_custom_metaboxes_lang.ed_link_title,
									body: [
									{
										type: 'textbox',
										label: uix_usercenter_custom_metaboxes_lang.ed_link_field_url,
										name: 'link_url',
										value: curlinkURL,
										placeholder: 'https://',
										multiline: true,
									...
									{
										type: 'textbox',
										label: uix_usercenter_custom_metaboxes_lang.ed_link_field_text,
										name: 'link_text',
										value: curlabel,
										multiline: true,
										minWidth: 500,
										...
										
									{
										...
										name: 'link_target',
										label: ' ',
										text: ' ' + uix_usercenter_custom_metaboxes_lang.ed_link_field_win,
									},
						...
						//Delete link button
						ed.addButton('uix_usercenter_cmb_unlink', {
							icon: 'mce-ico mce-i-unlink',
							tooltip: uix_usercenter_custom_metaboxes_lang.ed_unlink_title,
							onclick: function (e) {
						...
						ed.addButton('uix_usercenter_cmb_highlightcode', {
							...
							tooltip: uix_usercenter_custom_metaboxes_lang.ed_hcode_title,
							onclick: function (e) {
								
								
								ed.windowManager.open( {
									title: uix_usercenter_custom_metaboxes_lang.ed_hcode_title,
									body: [
                                        {
                                            type   : 'listbox',
                                            name   : 'lang',
                                            label  : uix_usercenter_custom_metaboxes_lang.ed_hcode_field_label,
                                            values : [
                                                { value: 'xml', text: 'xml' },
                                                { value: 'css', text: 'css' },
				  ...
				  content_css: [
					uix_usercenter_custom_metaboxes_lang.ed_url + 'css/uix-custom-metaboxes-editor.css'
				  ]
				});	
			}
...
( function ( $ ) {
	'use strict';
    $.fn.UixUserCenterEditorInit = function( options ) {
        ...
        this.each( function() {
            ...
            if ( $this.attr( 'aria-init' ) == 0 ) {
                ...
                $( document ).UixUserCenterMCEEditor({
...
( function ( $ ) {
	'use strict';
    $.fn.UixUserCenterToggleSelectInit = function( options ) {
 
        // This is the easiest way to have default options.
        const settings = $.extend({
            wrapper           : '.uix-usercenter-cmb__text--div--toggle.uix-usercenter-cmb__text--div--toggle-customlevel',
            wrapperChild      : '.uix-usercenter-cmb__text--div--toggle--child',
            fieldSelect       : '.uix-usercenter-cmb__text--div--toggle__sel', 
            fieldId           : '.uix-usercenter-cmb__text--div--toggle__id',
            fieldTitle        : '.uix-usercenter-cmb__text--div--toggle__title',
            fieldDefaultValue : '.uix-usercenter-cmb__text--div--toggle__toggleSelect',
            trigger           : '.uix-usercenter-cmb__text--div--toggle__trigger'
        }, options );
			...
			*/
			...
			const updateAppearance = function( data, stylesAndOrderUpdate ) {
				...
				*/	
				...
				$listItemsContainer.find( 'textarea.uix-usercenter-cmb__custom-attributes-field__resultData' ).val( createPHPData(variableResDataSortAllReversed) );

				$listItemsContainer.find( 'textarea.uix-usercenter-cmb__custom-attributes-field__resultReverseData' ).val( createPHPData(variableResDataSortAll) );
			...
			const selectBuilder = function( data, parentID, removeID ) {
				let html_code = '<select class="uix-usercenter-cmb__text--fullwidth uix-usercenter-cmb__text--div--toggle__sel">';
				...
				$( settings.wrapper ).each( function()  {
					...
					for (let k = 0; k < hasParentIDsRes.length; k++) {
						if (hasParentIDsRes[k] === _cid ) {
							let _codeEmpty = '<select class="uix-usercenter-cmb__text--fullwidth uix-usercenter-cmb__text--div--toggle__sel">';
					...
					//
					$wrapper.find( '.uix-usercenter-cmb__text--div--toggle__toggleSelect__append' ).html( _code ).promise().done( function(){

						//init default value for select control
						$wrapper.find( '.uix-usercenter-cmb__text--div--toggle__toggleSelect__append > select' ).val( _pid );
			...
			//
			$( document ).off( 'change.UixUserCenterToggleSelect' ).on( 'change.UixUserCenterToggleSelect', settings.wrapper + ' .uix-usercenter-cmb__text--div--toggle__toggleSelect__append > select', function() {
			...
			//
			$( document ).off( 'change.UixInputTextarea' ).on( 'change.UixInputTextarea', settings.wrapper + ' .uix-usercenter-cmb__text--div--toggle__title, ' + settings.wrapper + ' .uix-usercenter-cmb__text--div--toggle__classname, ' + settings.wrapper + ' .uix-usercenter-cmb__text--div--toggle__textarea, ' + settings.wrapper + ' textarea[data-enter-value="true"]', function() {
...
( function ( $ ) {
	'use strict';
    $.fn.UixUserCenterToggleSimpleSelectInit = function( options ) {
 
        // This is the easiest way to have default options.
        const settings = $.extend({ 
            type              : 'file',
            wrapper           : '.uix-usercenter-cmb__text--div--toggle:not(.uix-usercenter-cmb__text--div--toggle-customlevel)',
            trigger           : '.uix-usercenter-cmb__text--div--toggle__trigger'
        }, options );
        ...
        this.each( function( index ) {
            ...
            switch( defaultVal ) {
                case 'file':
                $this.closest( settings.wrapper ).find( '.uix-usercenter-cmb__text--row[data-type="file"]' ).show();
                $this.closest( settings.wrapper ).find( '.uix-usercenter-cmb__text--row[data-type="html"]' ).hide();
                break;

                case 'html':
                $this.closest( settings.wrapper ).find( '.uix-usercenter-cmb__text--row[data-type="file"]' ).hide();
                $this.closest( settings.wrapper ).find( '.uix-usercenter-cmb__text--row[data-type="html"]' ).show();
                break;      
            }      
            ...
            $this.off( 'change.UixUserCenterToggleSimpleSelect' ).on( 'change.UixUserCenterToggleSimpleSelect', function() {
 ...
 *************************************
 */	
function UixUserCenterGUIDCreate() {
 ...
 *************************************
 */	
function UixUserCenterGetRealIds( targetID ) {
